...
<body>
	...
	<div id="form_container">
		...
		<form id="form_907175" class="appnitro" method="get" action="StorageEditor?action=add&instance=customer">
			...
			<ul>
				...
				<li><label class="description" for="element_1">Name </label> <span>
						<input id="firstName" name="firstName" class="element text"
						size="8" /> <label>First</label>
				</span> <span> <input id="lastName" name="lastName"
						class="element text" size="14" /> <label>Last</label>
				</span></li>
				<li><label class="description" for="ipn">IPN </label>
					<div>
						<input id="ipn" name="ipn" class="element text medium" type="text" />
					</div></li>
				<li><label class="description" for="address">Address </label>
					<div>
						<input id="address" name="address" class="element text medium"
							type="text" />
					</div></li>
				<li><label class="description" for="phone">Phone </label>
					<div>
						<input id="phone" name="phone" class="element text medium"
							type="text" />
					</div></li>
